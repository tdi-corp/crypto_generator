    ...
    return (
        <>
                {/* <svg className="absolute opacity-20" width="100%" height="100%" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                    <filter id="filter0_f_17_23" x="-159.933" y="-159.933" width="719.867" height="719.867" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                ...
                <div className="relative flex flex-col items-center justify-center max-w-6xl px-8 py-12 mx-auto lg:py-24">
                  ...
                  <div className="grid grid-cols-1 gap-8 mt-12 lg:ap-2 lg:grid-cols-3">
                      ...
                      <div className="flex flex-col">
                        <div className="p-8 shadow-2xl rounded-3xl bg-gradient-to-b from-purple-400 via-purple-400 to-purple-600 ring-1 ring-white/10">
                          ...
                          <div className="flex mt-6">
                            <a className="items-center justify-between inline-flex w-full font-medium px-6 py-2.5 text-center text-black duration-200 bg-white rounded-xl h-14 hover:bg-white/20 hover:border-white hover:text-white focus:outline-none focus-visible:outline-black text-base focus-visible:ring-black" href="#">
                          ...
                          <div>
                            ...
                            <ul className="gap-4 mt-4 space-y-3 text-gray-300 list-none" role="list">
                              <li className="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-500 icon icon-tabler icon-tabler-circle-check" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div>
                      <div className="flex flex-col">
                        <div className="p-8 rounded-3xl bg-[#1c1f29] ring-1 ring-white/10 shadow-2xl">
                          ...
                          <div className="flex mt-6">
                            <a className="items-center justify-between inline-flex w-full font-medium px-6 py-2.5 text-center text-white duration-200 bg-white/5 border border-white/5 rounded-xl h-14 hover:bg-white/10 hover:border-white/10 focus:outline-none focus-visible:outline-black text-base focus-visible:ring-black" href="#">
                              Get starter <span>→</span>
                            </a>
                          </div>
                        </div>
                        <div className="px-8">
                          <div>
                            ...
                            <ul className="order-last gap-4 mt-4 space-y-3 text-gray-300 list-none" role="list">
                              <li className="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-300 icon icon-tabler icon-tabler-circle-check" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                  <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                  <path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0"></path>
                                  <path d="M9 12l2 2l4 -4"></path>
                                </svg>
                    ...
                    <div className="lg:order-first">
                      <div className="flex flex-col">
                        <div className="p-8 rounded-3xl bg-[#1a1d27] ring-1 ring-white/10 shadow-2xl">
                          <div className="flex justify-between">
                            <div className="flex items-center gap-3">
                              <svg className="w-8 h-8 text-black rounded-full" viewBox="0 0 280 280" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="280" height="280" rx="32" fill="#d1cfdf"></rect>
