...
export function DataTable() {
  ...
  const table = useReactTable({
    ...
    onRowSelectionChange: (fn: any) => dispatch(setRowSelectionsData(fn(rowSelectionData))),
    getRowId: row => row.id,
  ...
  return (
    <div className="w-full">
      {/* <div className="m my-16">
        <Button onClick={() => dispatch(setRowSelectionsData('ddd'))}>AAA</Button>
      </div> */}
